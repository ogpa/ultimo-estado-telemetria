...
def focus_monitoring(sid):
    url_Write_1 = "https://hst-api.wialon.com/wialon/ajax.html?svc=core/write_log&sid=" + sid
    tiempo_epoch = str(epoch())
    payload_Write_1 = 'params=%7B%22table%22%3A%22front_stats%22%2C%22stat%22%3A%7B%22feature_type%22%3A5189%2C%22action_type%22%3A518901%2C%22stat_value%22%3A%22Reports-Monitoring%22%2C%22time%22%3A' + tiempo_epoch + \
    ...
    payload_Write_2 = 'params=%7B%22table%22%3A%22front_stats%22%2C%22stat%22%3A%7B%22feature_type%22%3A5189%2C%22action_type%22%3A518902%2C%22stat_value%22%3A%22Reports%22%2C%22duration%22%3A227553%2C%22time%22%3A'+tiempo_epoch + \
    ...
    # Estoy omitiendo el Write Log de Click Outside
    ...
    payload_Update_1 = 'params=%7B%22itemId%22%3A22630230%2C%22name%22%3A%22hpnl%22%2C%22value%22%3A%22hb_mi_monitoring%22%7D&sid=' + sid
    headers_Update_1 = {
        'authority': 'hst-api.wialon.com',
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9',
    ...
    url_Set_locale_1 = "https://hst-api.wialon.com/wialon/ajax.html?svc=render/set_locale&sid=" + sid

    payload_Set_locale_1 = 'params=%7B%22tzOffset%22%3A-134170192%2C%22language%22%3A%22en%22%2C%22flags%22%3A259%2C%22formatDate%22%3A%22%25Y-%25m-%25E%20%25H%3A%25M%3A%25S%22%7D&sid=' + sid
    headers_Set_locale_1 = {
        'authority': 'hst-api.wialon.com',
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9',
        'content-type': 'application/x-www-form-urlencoded',
    ...
    response_Set_locale_1 = requests.request(
        "POST", url_Set_locale_1, headers=headers_Set_locale_1, data=payload_Set_locale_1)

    url_Update_2 = url_Update_1
    payload_Update_2 = 'params=%7B%22itemId%22%3A22630230%2C%22name%22%3A%22fpnl%22%2C%22value%22%3A%22monitoring%22%7D&sid=' + sid
    headers_Update_2 = {
        'authority': 'hst-api.wialon.com',
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9',
    ...
    url_Set_locale_2 = url_Set_locale_1

    payload_Set_locale_2 = 'params=%7B%22tzOffset%22%3A-134170192%2C%22language%22%3A%22en%22%2C%22flags%22%3A259%2C%22formatDate%22%3A%22%25Y-%25m-%25E%20%25H%3A%25M%3A%25S%22%7D&sid=' + sid
    headers_Set_locale_2 = {
        'authority': 'hst-api.wialon.com',
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9',
        'content-type': 'application/x-www-form-urlencoded',
    ...
    response_Set_locale_2 = requests.request(
        "POST", url_Set_locale_2, headers=headers_Set_locale_2, data=payload_Set_locale_2)
